...
public class DistanceSensorTest {
    ...
    public void testGetAdjustedDistance() {
        ...
        Assert.assertEquals(20, distanceSensorActions.getAverageDistanceAllInOne(true), 0);
    }

    @Test
    public void testGetExponentialSmoothedDistance() {
        fakeS1.setDistance(11);
        Assert.assertEquals(11, distanceSensorActions.getExponentialSmoothedDistance(true), 0.001);
        fakeS1.setDistance(-39);
        Assert.assertEquals(6, distanceSensorActions.getExponentialSmoothedDistance(true), 0.001);
//        Assert.assertEquals(10, distanceSensorActions.getExponentialSmoothedDistance(true), 0.001);
//        Assert.assertEquals(10, distanceSensorActions.getExponentialSmoothedDistance(true), 0.001);
//        Assert.assertEquals(10, distanceSensorActions.getExponentialSmoothedDistance(true), 0.001);
//        fakeS1.setDistance(100);
//        Assert.assertEquals(19, distanceSensorActions.getExponentialSmoothedDistance(true), 0.001);
//        Assert.assertEquals(27.1, distanceSensorActions.getExponentialSmoothedDistance(true), 0.001);
//        Assert.assertEquals(34.39, distanceSensorActions.getExponentialSmoothedDistance(true), 0.001);
    }
    @Test
    public void testDriveToObject() {
        fakeS1.setDistance(11);
        Assert.assertEquals(1, distanceSensorActions.driveToObject(1, 1, 0), 0.001);
        fakeS1.setDistance(-39);
        Assert.assertEquals(0.6666, distanceSensorActions.driveToObject(1, 1, 0), 0.01);
    }
}
